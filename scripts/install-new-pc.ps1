...
try {
  ...
  try {
    ...
    Write-Host "[OK] Desktop shortcut created/updated: Khmer Captions SRT" -ForegroundColor Green
  } catch {
  ...
  Write-Host "Double-click Khmer Captions SRT on the desktop or run run-windows.bat. Then open Settings > AI connection and paste your Gemini key."
  exit 0
} catch {
  Write-Host ""
